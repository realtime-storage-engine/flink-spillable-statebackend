...
/**
 * A {@link ListState} backed by spillable backend.
 *
 * @param <K> The type of the key.
 * @param <N> The type of the namespace.
 * @param <V> The type of the value.
 */
public class SpillableListState<K, N, V> extends AbstractHeapMergingState<K, N, V, List<V>, Iterable<V>>
	...
	public void add(V value) {
		...
		final SpillableStateTableImpl<K, N, List<V>> spillableStateTable =
			(SpillableStateTableImpl<K, N, List<V>>) stateTable;
	...
	static <E, K, N, SV, S extends State, IS extends S> IS create(
		...
		return (IS) new SpillableListState<>((StateTable<K, N, List<E>>) stateTable,
			keySerializer,
