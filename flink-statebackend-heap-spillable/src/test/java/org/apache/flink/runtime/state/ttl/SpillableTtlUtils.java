...
/**
 * Utilities for ttl state tests.
 */
public class SpillableTtlUtils {

	public static List<TtlStateTestContextBase<?, ?, ?>> getContexts() {
		return Arrays.asList(
			new TtlValueStateTestContext(),
			new TtlFixedLenElemListStateTestContext(),
			new TtlNonFixedLenElemListStateTestContext(),
			new SpillableTtlMapStateAllEntriesTestContext(),
